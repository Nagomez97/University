...
main:
  ...
  addi $t7, $t1, 2  # addi $r15, $r9, 2    -> r15=r9+2      = 3
  ...
  slti $t9, $t1, 0  # slti $r25, $r9, 0	   -> r25=1 si r9 < 0 else 0 = 0
  slti $t9, $t1, 5  # slti $r25, $r9, 5	   -> r25=1 si r9 < 5 else 0 = 1
